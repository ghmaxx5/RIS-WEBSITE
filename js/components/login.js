// RIS School — Production Login & Security Portal Component (Secure PIN Input)
  ...
  return `
    <div class="max-w-4xl mx-auto py-8 space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <!-- 3. ADMIN / PRINCIPAL ENTRY (Secured PIN) -->
        <div class="glass-card p-6 flex flex-col justify-between space-y-4 border-2 border-rose-500/20 hover:border-rose-500/50">
          <div class="space-y-3">
            ...
            <div>
              ...
              <input type="password" id="login-admin-pin" placeholder="Enter Security PIN" class="form-input text-xs font-mono" autocomplete="off">
            </div>
          </div>
